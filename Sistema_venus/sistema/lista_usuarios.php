			...
			<div class="table-responsive">
				<table class="table table-striped table-bordered" id="table">
					...
					<tbody>
						...
						$query = mysqli_query($conexion, "SELECT u.idusuario, u.nombre, u.correo, u.usuario, r.rol, u.imagen FROM usuario u INNER JOIN rol r ON u.rol = r.idrol");
						...
						if ($result > 0) {
							while ($data = mysqli_fetch_assoc($query)) { ?>
								<tr>
									...
									<td><div><img src="data:img/jpg;base64,<?php echo base64_encode($data['imagen']);?>"></div></td>
									<?php if ($_SESSION['rol'] == 1) { ?>
									<td>
